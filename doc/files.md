...
happy.conf        | contains configuration settings for happyd or happy-qt
happyd.pid        | stores the process id of happyd while running
...
debug.log           | contains debug information and general logging generated by happyd or happy-qt
