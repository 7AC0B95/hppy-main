...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " happy-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  happy-tx [options] <hex-tx> [commands]  Update hex-encoded happy transaction\n" +
            "or:     happy-tx [options] -create [commands]   Create hex-encoded happy transaction\n" +
            "\n";
