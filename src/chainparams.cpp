...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.happy.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.happytools.com");
        vSeeds.emplace_back("dnsseed.happypool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.happytools.com");
        vSeeds.emplace_back("seed-b.happy.loshan.co.uk");
