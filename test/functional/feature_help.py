...
"""Verify that starting happy with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start happy with -h for help text")
        ...
        self.log.info("Start happy with -version for version information")
        ...
        self.log.info("Start happyd with -fakearg to make sure it does not start")
